    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-section">
          ...
          <router-link to="/saved-properties" class="nav-item active">
    ...
    <main class="main-content">
      ...
      <div class="content-area">
        ...
        <div v-else-if="properties.length === 0" class="empty-state">
          ...
          <p>Start browsing and tap ❤️ to save properties you love.</p>
...
.btn-browse {
  padding: 9px 18px; background: var(--gold); color: var(--black);
