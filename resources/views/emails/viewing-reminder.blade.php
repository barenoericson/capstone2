...
@section('title', 'Viewing Reminder')

@section('content')
    <h2 style="margin:0 0 16px;font-size:20px;color:#100c08;">Viewing Tomorrow!</h2>

    <p style="margin:0 0 20px;font-size:15px;color:#374151;line-height:1.6;">
        @if($recipientRole === 'buyer')
            This is a friendly reminder that you have a property viewing scheduled for tomorrow.
        @else
            This is a friendly reminder that you have a property viewing scheduled for tomorrow.
        @endif
    </p>
